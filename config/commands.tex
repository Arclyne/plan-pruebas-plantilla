...
% ---------------------------------------------------------------------
% Redacción dependiente de la variante
%   El documento se refiere a sí mismo de forma distinta según se esté
%   rellenando o entregando: mientras es una plantilla habla de «esta
%   plantilla»; una vez entregado, de «este plan de prueba».
%
%     \segunvariante{texto en trabajo y anotada}{texto en la versión final}
%
%   Para suprimir un bloque entero en la versión final basta con
%   \ifversionfinal\else ... \fi
% ---------------------------------------------------------------------
\newcommand{\segunvariante}[2]{\ifversionfinal #2\else #1\fi}
