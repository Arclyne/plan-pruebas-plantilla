...
\begin{notanormativa}[La ejecución es un registro independiente del caso]
...
\begin{observacion}[No existía registro de ejecución]
\obsproblema{La plantilla anterior no preveía dónde registrar lo ocurrido al ejecutar. El
resultado real acababa escribiéndose sobre el propio caso de prueba, de modo que repetir un caso
—tras una corrección o en una campaña de regresión— borraba el resultado anterior y hacía
imposible demostrar cuándo se resolvió un defecto.}
\obscambio{Nuevo anexo con identificador propio de ejecución, versión del software,
configuración, entorno, datos, ejecutor, resultado real, veredicto, evidencia e incidente
asociado, más un registro consolidado.}
\obsjustificacion{«El resultado real se conserva en la ejecución para permitir repetir el mismo
caso sin sobrescribir su historial.»}
\obsfuente{OBS §3 y §6 · PDF §1.4 (TE3)}
\end{observacion}
