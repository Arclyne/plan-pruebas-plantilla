...
\ref{anx:ejecuciones}. Esta separación es la corrección más importante que introduce esta
plantilla respecto de la original, y es lo que permite ejecutar el mismo caso muchas veces sin
