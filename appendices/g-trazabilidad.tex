...
procedimiento, ejecución, evidencia e incidente—, con un diagrama que señala dónde se registra
cada eslabón y un resumen de cobertura de la base de prueba.}
\obsfuente{OBS §6}
\end{observacion}
...
apartado o anexo donde se registra cada eslabón.
\fi

No todos los proyectos necesitan todos los eslabones de la cadena: un proyecto sin análisis de
riesgo formal, o sin elementos de cobertura explícitos, puede dejar esas columnas vacías. Lo
importante es que la cadena permita \emph{expresarlos} cuando existan.
