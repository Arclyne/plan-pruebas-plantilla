...
\begin{observacion}[No existía registro de incidentes]
\obsproblema{La plantilla anterior no contemplaba ningún registro de incidentes, de modo que un
veredicto adverso no dejaba rastro documental ni podía comunicarse, priorizarse o cerrarse.}
\obscambio{Ficha con origen determinado (IR1), pasos de reproducción, versión y entorno,
severidad y prioridad como campos separados, responsable, estado, disposición y ejecución de
confirmación, más un registro consolidado.}
\obsfuente{OBS §3 y §6 · PDF §1.4 (IR2), §3.2}
\end{observacion}
