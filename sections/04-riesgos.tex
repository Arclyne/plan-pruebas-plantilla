...
\begin{notanormativa}[Riesgo del producto y riesgo del proyecto]
\begin{itemize}
...
\begin{observacion}[Riesgo de producto definido como riesgo de proyecto]
\obsproblema{La plantilla anterior definía el riesgo del producto como «cualquier suceso que
afecta el buen desarrollo de la prueba, su alcance y entrega a tiempo». Eso describe un riesgo
de proyecto, de modo que ambos apartados pedían lo mismo y el riesgo real sobre el usuario
quedaba sin registrar.}
\obscambio{El riesgo de producto se redefine por la consecuencia de un fallo del software sobre
usuarios, negocio, datos, seguridad u operación, con ejemplos contrastados; se añaden una escala
de valoración explícita y un cuadro de tratamiento.}
\obsjustificacion{Los riesgos de producto son la principal justificación de qué se prueba
primero y con qué profundidad; si se confunden con los de proyecto, la estrategia pierde su
fundamento.}
\obsfuente{OBS §4.1 · PDF §1.3 (TP3, TP4)}
\end{observacion}
