...
justificación en el apartado~\ref{sec:cobertura}. Por eso la Figura~\ref{fig:tecnicas} indica el
\emph{elemento de cobertura} que cada técnica produce, no un porcentaje. Alcanzar una cobertura
determinada tampoco demuestra la ausencia de defectos.
\end{notanormativa}
...
\obscambio{En la Figura~\ref{fig:tecnicas} se retiraron los porcentajes y se sustituyeron por el
...
—comprobar que no se rompió nada más— puede no estarse realizando. La
...
que obliga a fijar disparador, criterio de selección y responsable de cada una; la
Figura~\ref{fig:procesos} las dibuja como cajas distintas.}
