...
En el contexto del curso, la autoridad de aceptación es
\autoridadAceptacion\segunvariante{, definida en \texttt{config/metadata.tex}}{}. Si el
ejercicio académico no contempla una decisión real de aceptación, el cuadro debe indicarlo así y
limitarse a la recomendación del equipo: es preferible declarar que la decisión no aplica antes
que simularla.
...
organizacional\sidiag{, tal como muestra el bucle externo de la Figura~\ref{fig:procesos}}; una
lección que no llega a nadie no cierra ese bucle.
\end{instruccion}
