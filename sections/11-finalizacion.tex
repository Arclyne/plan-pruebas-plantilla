...
para evitar la confusión que la revisión señaló en la plantilla original. Leídos juntos
...
\emph{Resultados}. Es el error que la revisión detectó en la plantilla original.
\end{instruccion}
