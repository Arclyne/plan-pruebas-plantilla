...
ejecutar, controlar y cerrar las pruebas: los complementa. La Figura~\ref{fig:estructura}
muestra esa relación y señala qué apartados de este documento se apoyan en cada parte.
\end{notanormativa}

\input{diagrams/estructura-29119}
...
\input{diagrams/procesos-prueba}
...
\begin{notanormativa}[Declaración de alcance de esta plantilla]
Esta plantilla \textbf{no declara conformidad} con \norma. Organiza la planificación y el
cierre de un esfuerzo de prueba tomando como referencia el modelo de procesos de la parte~2 y
la estructura documental de la parte~3. Demostrar conformidad exigiría, además, evidencia de
que las actividades se realizaron y de que sus resultados fueron los especificados, y una
revisión del texto normativo completo de la edición elegida.
\end{notanormativa}
...
\textbf{Corrección respecto de la plantilla original:} cite siempre la \emph{edición} (año) de
cada norma y la \emph{versión} de cada fuente técnica. Una referencia como «\normap{4}, Anexo~A,
pp.~32--38» es ambigua sin el año, porque la paginación cambia entre ediciones. Cuando cite una
cláusula o anexo, verifíquelo en la edición que realmente consultó.
\end{instruccion}
...
\begin{instruccion}
Los seis términos siguientes se ofrecen ya redactados porque la revisión de la plantilla
original detectó que se confundían entre sí. Consérvelos, ajústelos si su proyecto usa otra
