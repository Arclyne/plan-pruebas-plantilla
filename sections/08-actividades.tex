...
Añada las \emph{dependencias} entre actividades y el \emph{producto} que cada una genera. Las
dependencias son las que hacen realista el cronograma del apartado~\ref{sec:calendario}; el
producto es lo que permite comprobar que la actividad terminó.
...
\sidiag{Puede apoyarse en la Figura~\ref{fig:procesos} para no omitir ninguna.}
\end{instruccion}
