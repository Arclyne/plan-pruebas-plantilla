...
Añada las \emph{competencias} requeridas por cada rol, la \emph{disponibilidad} real de cada
persona y las necesidades de \emph{formación} detectadas. La tarea TP6 de \normap{2} incluye
explícitamente definir competencias y necesidades de formación; una brecha entre competencia
requerida y disponible es un riesgo de proyecto y debería figurar en el
Cuadro~\ref{tab:riesgos-proyecto}.
\end{instruccion}
