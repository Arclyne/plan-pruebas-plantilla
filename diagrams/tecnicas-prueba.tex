...
que cada una produce.}
\label{fig:tecnicas}
\end{figure}

\begin{observacion}[Diagrama de técnicas]
\obsproblema{El diagrama de referencia fijaba «cobertura mínima: 100\,\%» para sentencias y
decisiones, atribuyendo ese umbral a la norma, y omitía el enfoque por palabras clave.}
\obscambio{Se retiran los porcentajes y cada técnica indica el elemento de cobertura que
produce; se añaden la conjetura de errores y las pruebas por palabras clave, marcadas como
opcionales, y una nota que remite el objetivo numérico al apartado~\ref{sec:cobertura}.}
\obsfuente{OBS §5.4 y §5.6 · DIAG}
\end{observacion}
